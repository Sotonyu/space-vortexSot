...
public sealed partial class FaxPrintout
{
    ...
    public FaxPrintout(string content, string name, string? label = null, string? prototypeId = null, string? stampState = null, List<StampDisplayInfo>? stampedBy = null, List<SignatureDisplayInfo>? signedBy = null, bool locked = false)
    {
        Content = content;
        Name = name;
        Label = label;
